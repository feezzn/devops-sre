variable "environment" {
  description = "Deployment environment. This root module only accepts hml."
  type        = string

  validation {
    condition     = var.environment == "hml"
    error_message = "The hml root module only accepts environment = \"hml\"."
  }
}
